...
export const WHATS_NEW = "📖 O Caderno Técnico virou v2: o MAPA DE CABOS agora é orientação de MONTAGEM (região de cada cabo com contorno, selo de onde o cabo entra e a contagem \"N gab\" — o desenho denso com trajeto e setas continua na aba Cabeamento); a seção de Vídeo mostra as telas NA DISPOSIÇÃO DA COMPOSIÇÃO (com coluna de Fração do aspecto); a Elétrica ganhou BALANÇO POR FASE com pico E típico; e uma folha nova de CRITÉRIOS DE CÁLCULO declara as regras, as normas (NBR 5410, NEC, IEC) e as referências por trás dos números. 🧹 Sem folha vazia, tabelas de AC sem estourar a página e PDF ~2,5× mais leve.";
