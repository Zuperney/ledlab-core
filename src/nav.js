...
import {
  LayoutDashboard, CalendarDays, Receipt, Package, FolderOpen,
...
export const WHATS_NEW = "AC atrelado ao sinal agora balanceia a carga entre os cabos (ex.: 13+12 em vez de 22+3).";
