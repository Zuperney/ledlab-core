...
export const WHATS_NEW = "🧰 MÃO DE OBRA: cadastre o que cada técnico faz (Montagem, Resolume, Endereçamento…) tocando no nome dele em Equipe & avisos — e, na hora de montar a escala, a faixa \"Precisa de:\" filtra quem resolve. Acabou de decorar a habilidade de cada um. 📐 CADERNO REDESENHADO: a folha do mapa de cabos agora é só o mapa, do tamanho da página; a lista cabo a cabo se juntou na nova seção CABOS, que abre com a capacidade de cada porta e circuito (e a folga que sobra); e os Critérios de Cálculo voltaram a caber numa folha só.";
