...
export const WHATS_NEW = "⚡ A elétrica passou por AUDITORIA DE ENGENHARIA (fórmulas confrontadas com normas e fontes — todas confirmadas) e ficou mais honesta: a tensão aparece completa (\"220 V · Trifásico\") e cada cabo AC ganhou sua FASE (rodízio R/S/T por Screen; em 220 V trifásico, pares RS/ST/TR) com card de BALANÇO POR FASE na aba Energia. 🔌 O app NÃO sugere mais disjuntor — entrega corrente e kVA, e a proteção é do eletricista do quadro: consulte a tabela nova de BITOLAS, DISJUNTORES E DISTÂNCIAS na Base de Conhecimento. ⛽ O gerador agora é dimensionado pelo PICO ×1,25 (frame branco é cenário real!) e a linha Típico mostra o % ocupado do gerador (saudável: 60–80%).";
