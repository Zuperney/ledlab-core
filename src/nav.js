...
export const WHATS_NEW = "🔌 O MAPA DE CABOS do Caderno agora fala a língua do LCT (estilo SmartLCT/NovaStar): cada cabo pinta sua região com uma COR PASTEL, a SERPENTINA azul mostra a ordem elétrica real com setas, a ENTRADA é um selo verde numerado e o FIM do cabo é um ponto vermelho — no sinal e no AC, com a tabela de portas cruzando com o mapa pela cor. A aba Cabeamento continua com o desenho denso de trabalho (e também ganhou o ponto de fim). 🏗️ E o rigging saiu do app: o dimensionamento de estrutura fica com quem é do ofício até o 3D chegar — o peso da parede continua no Caderno, e o checklist de parede voada segue na Base de Conhecimento.";
