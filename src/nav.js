...
export const WHATS_NEW = "👥 EQUIPE & AVISOS: monte sua equipe (Configurações → Equipe & avisos), mande o código de convite por WhatsApp e escale os técnicos direto na aba Equipe do evento. Quem é escalado vê o evento na própria Agenda (somente leitura) e recebe AVISO no sino — e no celular, com o app instalado na tela de início e \"Avisos no celular\" ligado, o aviso chega mesmo com o app fechado. 📣 Convocar equipe (disparo manual), lembrete automático por horário de chamada, e LGPD de fábrica: seu e-mail nunca aparece pra ninguém, sobe só o básico do evento.";
