...
export const WHATS_NEW = "🏗️ O Caderno Técnico ganhou a seção PESO E ANCORAGENS: peso da parede, quantos bumpers e ancoragens ela pede, quanto carrega a pior delas — e A CADEIA, que mostra o que trava primeiro (o limite do fabricante, a talha, ou a treliça que o app não alcança). Vem com o checklist de campo antes de subir. No cadastro do gabinete, em Especificações Avançadas, você registra os limites do fabricante e a procedência; o que não estiver preenchido sai como NÃO INFORMADO no papel — nunca como estimativa. Na Base de Conhecimento, categoria nova: Estrutura. ⚠️ Correção importante: na primeira versão o limite cadastrado não chegava no Caderno, que saía sempre como NÃO INFORMADO — agora chega, e é lido da Biblioteca (confirmar o número hoje vale pro caderno emitido antes). A capa também parou de quebrar em duas páginas no Imprimir do navegador.";
