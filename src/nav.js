...
export const WHATS_NEW = "🪪 SEU NOME NA CONTA: defina uma vez em Conta & sincronização e ele preenche sozinho o entrar-na-equipe (com ajuste por equipe no \"alterar\"). ✉️ CONVITE PRONTO: o Copiar agora leva a mensagem completa pro WhatsApp — link do app, passo a passo e código. 🔔 Avisos mais espertos: aparelho que já permitiu religa sozinho ao logar, o botão mostra \"Ativando…\" em vez de travar, e o lembrete por horário de chamada foi consertado (não chegava ao servidor).";
