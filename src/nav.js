...
export const WHATS_NEW = "📄 CADERNO DE DESIGN SEM FOLHA EM BRANCO: o PDF saía com uma prancha vazia, só com moldura e carimbo, no meio do caderno — e a folha de Conteúdo transbordava pra seguinte, deixando quase uma página perdida. As duas coisas foram corrigidas: cada seção começa onde tem que começar e cabe onde começou. 🖼️ A FOLHA DE CONTEÚDO É SÓ O DESENHO: as fichas \"Painel de LED\" e \"Manual de conteúdo\" saíram do papel — a do painel repetia a Visão Geral e o Vídeo/Resolução, e o conjunto era informação demais numa folha que é visual. O esquema das telas em escala comum ficou com a prancha quase inteira. O manual de vídeo continua em Dados › Manual de conteúdo, editável por projeto — só não sai impresso.";
