...
export const WHATS_NEW = "📐 O modo Distância virou uma CENA: a parede de LED em escala, uma pessoa de 1,70 m e o chão pintado com as quatro réguas — ARRASTE a pessoa (ou toque no chão) e veja o veredito mudar ao vivo, com o quadro \"O QUE O OLHO VÊ\" mostrando os LEDs separarem quando perto demais e a imagem ficar lisa da distância retina em diante. 🖼️ E o preview de crop agora recorta uma IMAGEM DE VERDADE: dá pra ver o que o \"preencher\" corta e o que o \"encaixar\" preserva (um toggle volta pro esquema geométrico).";
