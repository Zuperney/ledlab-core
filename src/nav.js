...
export const WHATS_NEW = "🏗️ A seção de estrutura do Caderno Técnico mudou: agora se chama PESO E ESTRUTURA e ficou só com o que é fato — peso da parede e a checagem contra os limites publicados pelo fabricante. O dimensionamento de bumpers, ancoragens e talha saiu (aqueles números eram estimativa da casa e liam como fato no papel — quem dimensiona é o rigger). Em troca, na aba Relatório você escolhe o TIPO DE MONTAGEM (voada ou sentada — e a sentada finalmente usa o limite de empilhamento cadastrado no gabinete) e decide, pela âncora na barra de ferramentas, se a seção entra ou não no Caderno Completo. O relatório Estrutural continua mostrando a seção sempre.";
