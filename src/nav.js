...
export const WHATS_NEW = "📖 UMA PALAVRA POR CONCEITO: o app inteiro foi varrido pra falar a mesma língua — Porta é sinal, CIRCUITO é AC (adeus \"Cabo 3\" na energia), CADEIA é o encadeamento de gabinetes (corrente voltou a ser só ampères), CONTROLADORA unificou os 5 nomes da caixa NovaStar, e a aba Relatório virou CADERNO do clique à capa. ✍️ Proporção + Fração, \"distâncias de visão\" (régua é só a de porta), grafias powerCON/NovaStar e dezenas de miúdas de voz. A convenção completa mora no manual de marca (§12.1).";
