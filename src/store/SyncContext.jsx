...
export function SyncProvider({ children }) {
  ...
  const runSync = useCallback(async () => {
    ...
    try {
      await syncAll(user.id, [
        ...
        { key: KEYS.equips, value: app.equips, apply: app.setEquips },
      ]);
      setStatus("synced");
  ...
  }, [user, app.cabs, app.projects, app.prefs, app.tcPresets, app.worklog, app.activityTypes, app.equips,
      app.setCabs, app.setProjects, app.setPrefs, app.setTcPresets, app.setWorklog, app.setActivityTypes, app.setEquips]);
